        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ChipsetSeries = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    GPU = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CUDA = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Supported3DAPI = table.Column<string>(type: "nvarchar(max)", nullable: false),
